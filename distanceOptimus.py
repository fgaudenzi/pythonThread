...
if __name__ == '__main__':
    ...
    for i in xrange(0,10):
        ...
        for fi in ff:
            f_result=[]
            for dir in ["/Users/iridium/ris_12/newEXP/experimentPaper/average_h3/","/Users/iridium/ris_12/newEXP/experimentPaper/fitting_h3/"]:
                if(1!=0):
                    fname=dir+"dataset-"+str(i)+"-task_"+str(fi)+"k-"+str(40)+".result"
                    #print fname
                    y=[]
