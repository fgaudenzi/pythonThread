...
if __name__ == '__main__':
    ...
    i=0
    print ("combination functions",file=log)
    for combo in res:
        i=i+1
        print ("%d)\t  %s" % (i,combo),file = log)
    ...
    costa=alg.property_based_fca(combination,[0,1,1,2,0,5,7,8,9])
    costb=alg.prioperty_based_fcb(combination,[0,1,1,2,0,5,7,8,9])
